package com.dbeginc.dbweather.utils.customviews.animation;
...
public class AnimatorProxy extends Animation {
    ...
    public static final boolean NEEDS_PROXY = Integer.valueOf(Build.VERSION.SDK_INT) < Build.VERSION_CODES.HONEYCOMB;
