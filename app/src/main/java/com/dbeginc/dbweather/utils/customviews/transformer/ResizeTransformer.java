...
public class ResizeTransformer extends Transformer {
     ...
     *
     * @param verticalDragOffset used to calculate the newData size.
     */
     ...
     *
     * @param verticalDragOffset used to calculate the newData X position.
     */
    @Override
     ...
     *
     * @param verticalDragOffset used to calculate the newData right position.
     */
