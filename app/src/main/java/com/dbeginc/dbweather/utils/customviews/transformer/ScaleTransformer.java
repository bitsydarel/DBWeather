package com.dbeginc.dbweather.utils.customviews.transformer;

import android.view.View;

import com.dbeginc.dbweather.utils.customviews.draggableview.ViewHelper;
...
public class ScaleTransformer extends Transformer {
     ...
     *
     * @param verticalDragOffset used to calculate the newData scale.
     */
     ...
     *
     * @param verticalDragOffset used to calculate the newData position.
     */
