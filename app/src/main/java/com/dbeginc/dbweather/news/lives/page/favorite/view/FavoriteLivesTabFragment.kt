...
package com.dbeginc.dbweather.news.lives.page.favorite.view
 ...
 */
class FavoriteLivesTabFragment : BaseFragment(), FavoriteLivesTabContract.FavoriteLivesTabView {
    @Inject lateinit var presenter: FavoriteLivesTabContract.FavoriteLivesTabPresenter
    ...
    override fun onCreate(savedState: Bundle?) {
        ...
        adapter = if (savedState == null) FavoriteLiveAdapter(mutableListOf()) else FavoriteLiveAdapter(savedState.getList<LiveModel>(ConstantHolder.LIVES_DATA).toMutableList())
    }
    ...
    override fun showError(message: String) {
        binding.favoriteLivesLayout.snack(message)
    }
}