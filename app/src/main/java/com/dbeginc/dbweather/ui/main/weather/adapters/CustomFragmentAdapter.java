...
import com.dbeginc.dbweather.ui.main.weather.viewpagerfragment.WeatherFragment;
...
public class CustomFragmentAdapter extends android.support.v4.app.FragmentPagerAdapter  {
    ...
    public void updateFragments(@NonNull final List<WeatherInfo> weatherInfoList) {
        ...
        final int weatherInfoListSize = mWeatherInfoList.size();

        for (int index = 0; index < weatherInfoListSize; index++) {
