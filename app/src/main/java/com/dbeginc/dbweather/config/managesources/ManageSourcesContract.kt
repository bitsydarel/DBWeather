 ...
 *
 * Manage Sources Contract
 */
interface ManageSourcesContract {
    /**
     * Manage Sources View
     */
    interface ManageSourcesView : IView {
        ...
        fun goBackToConfigurations()

        fun showError(message: String)
    }

    /**
     * Manage Sources Presenter
     */
    interface ManageSourcesPresenter: IPresenter<ManageSourcesView> {
