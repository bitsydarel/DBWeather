...
interface ManageLocationsPresenter : IPresenter<ManageLocationsView> {
    fun loadUserLocations(view: ManageLocationsView)

    fun removeLocation(view: ManageLocationsView, removedItem: LocationWeatherModel)

    fun goBack(view: ManageLocationsView)
}