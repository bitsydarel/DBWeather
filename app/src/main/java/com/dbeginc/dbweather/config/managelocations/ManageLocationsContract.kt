...
package com.dbeginc.dbweather.config.managelocations
 ...
 *
 * Manage Locations Contract
 */
interface ManageLocationsContract {

    interface ManageLocationsView : IView {
        fun displayLocations(locations: List<LocationWeatherModel>)

        fun displayNoLocations()

        fun showUpdateStatus()

        fun hideUpdateStatus()

        fun showLocationRemovedMessage()
    ...
    interface ManageLocationsPresenter: IPresenter<ManageLocationsView> {
        fun loadUserLocations()

        fun removeLocation(removedItem: LocationWeatherModel)
