...
interface IntroContract {
    ...
    interface IntroView : IView {
        fun displayChooseLocation()

        fun displayGpsLocationFinder()
    }

    interface IntroPresenter : IPresenter<IntroView> {
        fun onUserChoose(choice: Int)
    }
}