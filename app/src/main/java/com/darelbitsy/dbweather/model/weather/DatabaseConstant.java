...
public class DatabaseConstant {
    ...
    public static final String HOUR_PRECIPCHANCE = "precipice_chance";
    public static final String HOUR_PRECIPTYPE = "precipice_type";
    ...
    public static final String MINUTELY_PRECIPCHANCE = "precipice_chance";
    public static final String MINUTELY_PRECIPTYPE = "precipice_type";
