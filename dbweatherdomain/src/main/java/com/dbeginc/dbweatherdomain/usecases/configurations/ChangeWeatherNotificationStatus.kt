 ...
 */
class ChangeWeatherNotificationStatus(private val configurationsRepository: ConfigurationsRepository) : UseCaseCompletable<Boolean>() {

    override fun buildUseCase(params: Boolean): Completable = configurationsRepository.changeWeatherNotificationStatus(params)
