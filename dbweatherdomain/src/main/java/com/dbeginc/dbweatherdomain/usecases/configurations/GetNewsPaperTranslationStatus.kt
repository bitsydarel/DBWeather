 ...
 */
class GetNewsPaperTranslationStatus(private val configurationsRepository: ConfigurationsRepository) : UseCaseSingle<Boolean, Unit>() {

    override fun buildUseCase(params: Unit): Single<Boolean> = configurationsRepository.getNewsPapersTranslationStatus()
