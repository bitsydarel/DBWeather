 ...
 *
 * Get All Location for a specific query
 */
class GetLocations(private val repository: WeatherRepository) : UseCase<List<Location>, LocationRequest>(){
    override fun buildUseCase(params: LocationRequest): Flowable<List<Location>> {
        return repository.getLocations(params)
    }
