 ...
 */
class DefineDefaultSubscribedSources(private val newsRepository: NewsRepository) : UseCaseCompletable<List<String>>() {

    override fun buildUseCase(params: List<String>): Completable = newsRepository.defineDefaultSubscribedSources(params)
