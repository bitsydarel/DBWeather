 ...
 */
class UnSubscribeToSource(private val newsRepository: NewsRepository) : UseCaseCompletable<SourceRequest<Source>>() {

    override fun buildUseCase(params: SourceRequest<Source>): Completable = newsRepository.unSubscribeToSource(params)
