 ...
 *
 * Get Lives Stream UseCase
 */
class GetLives(private val repo: NewsRepository): UseCase<List<Live>, List<String>>() {

    override fun buildUseCase(params: List<String>): Flowable<List<Live>> = repo.getLives(params)
