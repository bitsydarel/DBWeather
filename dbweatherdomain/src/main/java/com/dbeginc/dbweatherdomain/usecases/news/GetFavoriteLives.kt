 ...
 * Get Favorite Lives
 */
class GetFavoriteLives(private val repo: NewsRepository) : UseCase<List<String>, Unit>() {

    override fun buildUseCase(params: Unit): Flowable<List<String>> = repo.getFavoriteLives()
