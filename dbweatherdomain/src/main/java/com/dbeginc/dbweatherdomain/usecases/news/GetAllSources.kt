 ...
 * Get all sources
 */
class GetAllSources(private val newsRepository: NewsRepository) : UseCase<List<Source>, Unit>() {

    override fun buildUseCase(params: Unit): Flowable<List<Source>> = newsRepository.getSources()
