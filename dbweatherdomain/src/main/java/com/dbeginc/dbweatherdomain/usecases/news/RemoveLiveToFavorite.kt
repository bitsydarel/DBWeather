 ...
 *
 * Remove Live To Favorite
 */
class RemoveLiveToFavorite(private val repo: NewsRepository): UseCaseCompletable<LiveRequest<Unit>>() {

    override fun buildUseCase(params: LiveRequest<Unit>): Completable = repo.removeLiveFromFavorite(params)
