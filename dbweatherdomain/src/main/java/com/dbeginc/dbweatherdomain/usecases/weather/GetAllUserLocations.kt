 ...
 */
class GetAllUserLocations(private val weatherRepo: WeatherRepository) : UseCase<List<Location>, Unit>() {
    override fun buildUseCase(params: Unit): Flowable<List<Location>> = weatherRepo.getAllUserLocations()
    override fun clean() = weatherRepo.clean()
}