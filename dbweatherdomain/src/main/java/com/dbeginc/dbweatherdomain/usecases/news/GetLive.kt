 ...
 * Get Live UseCase
 */
class GetLive(private val repo: NewsRepository) : UseCaseSingle<Live, LiveRequest<Unit>>(){
    override fun buildUseCase(params: LiveRequest<Unit>): Single<Live> = repo.getLive(params.name)
