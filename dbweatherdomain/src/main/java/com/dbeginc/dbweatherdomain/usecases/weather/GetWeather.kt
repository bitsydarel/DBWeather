 ...
 *
 * Get Weather For Current User
 */
class GetWeather(private val repo: WeatherRepository) : UseCase<Weather, WeatherRequest<String>>() {

    override fun buildUseCase(params: WeatherRequest<String>): Flowable<Weather> = repo.getWeather(params)
