...
interface RemoteLivesDataSource {
    fun getAllYoutubeLives(): Single<List<YoutubeLive>>

    fun getYoutubeLive(name: String): Single<YoutubeLive>

    fun getAllIpTvPlaylist(): Single<List<IpTvPlaylist>>
